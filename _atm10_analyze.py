...
OUTPUT_ASSETS = os.path.join(PROJECT_ROOT, "output", "assets")
RAW_JSON = os.path.join(PROJECT_ROOT, "_atm10_mods_raw.json")

from mod_sources import CLONE_BRANCHES, MOD_REPOS
...
def main():
    ...
    report_path = os.path.join(PROJECT_ROOT, "_atm10_research.md")
