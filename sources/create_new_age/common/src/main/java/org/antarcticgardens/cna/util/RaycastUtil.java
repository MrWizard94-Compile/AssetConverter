...
public class RaycastUtil {
    public static HitResult pickBlockFromPos(Level world, Vec3 pos, Vec3 dir, float distance, @Nullable Entity player) {
        Vec3 vec33 = pos.add(dir.x * distance, dir.y * distance, dir.z * distance);
        return world.clip(new ClipContext(pos, vec33, ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, player));
    }
