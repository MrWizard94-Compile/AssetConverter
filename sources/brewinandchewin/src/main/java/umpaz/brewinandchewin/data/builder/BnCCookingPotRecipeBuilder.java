...
public class BnCCookingPotRecipeBuilder{
    ...
    public BnCCookingPotRecipeBuilder unlockedBy(String criterionName, CriterionTriggerInstance criterionTrigger) {
    ...
    public void build(Consumer<FinishedRecipe> consumerIn) {
        ...
        build(consumerIn, BrewinAndChewin.MODID + ":cooking/" + location.getPath());
    }
    ...
    public void build(Consumer<FinishedRecipe> consumerIn, ResourceLocation id) {
        if (!advancement.getCriteria().isEmpty()) {
            ...
            consumerIn.accept(new BnCCookingPotRecipeBuilder.Result(id, result, count, ingredients, cookingTime, experience, container, tab, advancement, advancementId));
        } else {
            consumerIn.accept(new BnCCookingPotRecipeBuilder.Result(id, result, count, ingredients, cookingTime, experience, container, tab));
        }
    }
