...
public final class ModRecipeTypes {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<IOreInfusionRecipe>> ORE_INFUSION = REGISTRY.register("ore_infusion", () -> RecipeType.simple(MysticalAgriculture.resource("ore_infusion")));
