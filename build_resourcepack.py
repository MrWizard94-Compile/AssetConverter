...
SOURCE_ASSETS_DIR = os.path.join(PROJECT_ROOT, "output", "assets")
BUILD_DIR = os.path.join(PROJECT_ROOT, "output", "resourcepack")
PACK_NAME = "Base-Wars_32x"
DEPLOY_DIR = (
    r"C:\Users\Bulkl\curseforge\minecraft\Instances\Base-Wars_Stripped\resourcepacks"
)
