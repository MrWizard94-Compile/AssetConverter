...
def find_source_texture_roots(mod_name):
    suffix = os.path.join("assets", mod_name, "textures")
    repo_names = [mod_name]
...
def find_source_textures_dir(mod_name):
    ...
    for repo_name in repo_names:
        candidates.extend([
            os.path.join(PROJECT_ROOT, repo_name, "src", "main", "resources", suffix),
            os.path.join(
                PROJECT_ROOT, repo_name, "common", "src", "main", "resources", suffix
            ),
            os.path.join(
                PROJECT_ROOT, repo_name, "Common", "src", "main", "resources", suffix
            ),
            os.path.join(
                PROJECT_ROOT, repo_name, "Xplat", "src", "main", "resources", suffix
            ),
            os.path.join(
                PROJECT_ROOT,
                repo_name,
    ...
    candidates.extend([
        os.path.join(PROJECT_ROOT, mod_name, "src", "main", "resources", suffix),
    ])
    ...
    for repo_name in repo_names:
        mod_root = os.path.join(PROJECT_ROOT, repo_name)
...
def texture_paths(mod_name):
    ...
    target_project_dir = os.path.join(PROJECT_ROOT, "output", "assets", mod_name, "textures")
